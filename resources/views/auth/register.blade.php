        ...
        <div class="space-y-12">
            <div class="border-b border-gray-900/10 pb-12">
                ...
                <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <x-form-field>
                        <x-form-label for="first_name">First Name
                        </x-form-label>
                    ...
                    <x-form-field>
                        <x-form-label for="last_name">Last Name
                        </x-form-label>
                    ...
                    <x-form-field>
                        <x-form-label for="password">Password
                        </x-form-label>
                    ...
                    <x-form-field>
                        <x-form-label for="password_confirmation">Confirm Password
                        </x-form-label>
